package cn.oi.klittle.era.view.datepicker;
 ...
 * @version 1.1.0
 */
public class WheelPicker extends View implements KIDebug, KIWheelPicker, Runnable {
    ...
    public void setSelectedItemPosition(int position) {
        ...
        //fixme 很重要，触发联动的关键。
        if (null != mOnItemSelectedListener&&mData!=null&&mData.size()>position)
            mOnItemSelectedListener.onItemSelected(this, mData.get(position), position);
    }
