package cn.oi.klittle.era.activity.photo.config;
    ...
    public static String s(Context context, int mediaMimeType) {
        ...
        switch (mediaMimeType) {
            case PictureConfig.TYPE_IMAGE:
                return ctx.getString(R.string.kpicture_error);
            case PictureConfig.TYPE_VIDEO:
                return ctx.getString(R.string.kpicture_video_error);
            case PictureConfig.TYPE_AUDIO:
                return ctx.getString(R.string.kpicture_audio_error);
            default:
                return ctx.getString(R.string.kpicture_error);
        }
    }
