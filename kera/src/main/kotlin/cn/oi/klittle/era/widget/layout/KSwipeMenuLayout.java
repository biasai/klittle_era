package cn.oi.klittle.era.widget.layout;
...
//            KBaseUi.apply {
//                kSwipeMenuLayout {}.apply {
//                    //fixme 使用apply{}；自定义布局就可以正常的使用lparams{}了
//                    backgroundColor = Color.RED
//                    linearLayout {
//                        button { text = "你好" }
//                    }.lparams {
//                        width = kpx.x(750)//fixme 一定要设置宽度
//                        height = matchParent
//                    }
//                    button { text = "删除" }.lparams {
...
//smoothExpand() fixme 开(展开)
//smoothClose() fixme 关

/**
 * fixme 侧滑菜单
 */
public class KSwipeMenuLayout extends ViewGroup {
    ...
    //存储的是当前正在展开的View
    private static KSwipeMenuLayout mViewCache;
    ...
    public KSwipeMenuLayout(Context context) {
        this(context, null);
        init(context);
    }

    public KSwipeMenuLayout(ViewGroup viewGroup) {
    ...
    public KSwipeMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context);
    }

    public KSwipeMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param ios
     */
    public KSwipeMenuLayout setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public KSwipeMenuLayout setLeftSwipe(boolean leftSwipe) {
     ...
     * @return
     */
    public static KSwipeMenuLayout getViewCache() {
        return mViewCache;
    }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childView.getVisibility() != GONE) {
                ...
                if (params != null && params instanceof MarginLayoutParams) {
                    final MarginLayoutParams lp = (MarginLayoutParams) params;
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = KSwipeMenuLayout.this;
