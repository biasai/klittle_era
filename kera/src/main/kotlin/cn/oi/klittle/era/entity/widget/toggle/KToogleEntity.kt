 ...
 */
data class KToogleEntity(var shadow_radius: Float = 0f, var shadow_dx: Float = 0f, var shadow_dy: Float = 0f, var width: Int = 0, var height: Int = 0, var left_top: Float = 0f, var left_bottom: Float = 0f, var right_top: Float = 0f, var right_bottom: Float = 0f,
