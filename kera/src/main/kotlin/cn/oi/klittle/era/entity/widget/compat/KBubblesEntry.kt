 ...
 * @param xOffset 气泡的偏移量（整体偏移）；气泡三角，x轴偏移量，正数向右偏移，负数向左偏移；(fixme 即：正数向内偏移，负数向外偏移。)
 ...
 * @param isDrawRightStroke 是否绘制右边的边框（气泡顶点对应的底边）;默认不绘制。
 * @param isDraw 是否绘制
